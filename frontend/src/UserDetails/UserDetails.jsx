...
const UserDetails = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => navigate('/recipes'), 1200); // Navigate to recipes after save
  };
  ...
  return (
    <div className="userdetails-layout">
      ...
      <div className="userdetails-image-box">
        <img
          src="https://i.pinimg.com/736x/b0/bd/73/b0bd731b11f02b764dab1e0df4d19739.jpg"
          alt="Random Visual"
          className="userdetails-side-image"
        />
      </div>
    </div>
  );
